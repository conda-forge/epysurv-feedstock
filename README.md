About epysurv-feedstock
=======================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/epysurv-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=7128&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/epysurv-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `epysurv` can be installed with `conda`:
...
```
mamba install epysurv
```

It is possible to list all of the versions of `epysurv` available on your platform with `conda`:
...
```
mamba search epysurv --channel conda-forge
```
...
mamba repoquery search epysurv --channel conda-forge

# List packages depending on `epysurv`:
mamba repoquery whoneeds epysurv --channel conda-forge

# List dependencies of `epysurv`:
mamba repoquery depends epysurv --channel conda-forge
```
